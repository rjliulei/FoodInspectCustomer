...
-(void)show
{
	...
	// table view creation
	self.table = [[PullTableView alloc] initWithFrame:CGRectZero style:UITableViewStylePlain];
    ...
    self.table.pullArrowImage = [UIImage imageNamed:@"blackArrow"];
    self.table.pullBackgroundColor = [UIColor yellowColor];
    self.table.pullTextColor = [UIColor blackColor];
